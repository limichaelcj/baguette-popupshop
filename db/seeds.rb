...
User.create(name: 'Bianca', email: 'bianca_kann@gmail.com', password: "123456")
User.create(name: 'Sonja', email: 'sonjaharoldsondesigns@gmail.com', password: "123456")
User.create(name: 'Luz', email: 'lmc580@nyu.edu', password: "123456")

sam = User.create(name: 'Sam', email: "sam@gmail.com", password: "123456")
jordan = User.create(name: 'Jordan', email: "joradn@gmail.com", password: "123456")
