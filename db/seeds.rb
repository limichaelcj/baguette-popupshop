...
blue_bottle = Venue.new(name: 'Blue Bottle', address: '16 Villa Gaudelet, Paris', price: 1000, medium: "Painting", style: "Pop Art", host: sam)
blue_bottle.description = "We are located in the alley of Paris center south side. We have a plain white wall to display art pritns."
...
glitch = Venue.new(name: 'Glitch', address: '106 Rue de Turenne, 75003 Paris, France', price: 2000, medium: "Ceremics", style: "Naturalism", host: jordan)
glitch.description = "We are part of the Japanese coffee culture, and we would like to show great respect to the craftmanship."
glitch.remote_photo_url = url_glitch
glitch.save

url_streamer = "https://en.goodcoffee.me/cms/wp-content/uploads/streamer-nakameguro-2.jpg"
streamer = Venue.new(name: 'Streamer', address: '68 Rue de Grenelle, 75007 Paris, France', price: 1500, medium: "Drawing", style: "Cubism", host: mike)
streamer.description = "We do Cold Brew, developed our own Nitro, and we are looking for colorful and fun illustrations to display in our store."
...
underground = Venue.new(name: 'Underground', address: "13 Rue d'Ormesson, 75004 Paris, France", price: 500, medium: "Installation", style: "Pixel Art", host: sam)
underground.description = "We are a new and uprising art gallery located in the center of Paris. We want to promote young and local artists to kickstart their careers."
...
puts "  Seeding events..."
Event.create(venue: streamer, artist: bianca, date: "2018-11-17")
Event.create(venue: streamer, artist: sonja, date: "2018-11-21")
Event.create(venue: streamer, artist: luz, date: "2018-11-30")
